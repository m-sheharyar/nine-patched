...
export function TopBar({ dark, fileName, onFileNameChange, onToggleDark, onReset, onDownload }: TopBarProps) {
  return (
    <header className="flex shrink-0 flex-wrap items-center gap-x-3 gap-y-2 border-b border-zinc-200 bg-white px-3 py-2 dark:border-zinc-800 dark:bg-zinc-900">
      ...
      <p className="hidden text-[11px] text-zinc-500 lg:block dark:text-zinc-400">
